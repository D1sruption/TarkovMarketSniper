...
//=====================================================
// initialize settings
settings.setValue("Profile.username", "USERNAME HERE"); //username
settings.setValue("Profile.password", "MD5 OF PASSWORD HERE"); //MD5 of password
settings.setValue("Profile.hwCode", "hwCode=#HWCODE HERE"); //HWID
settings.setValue("Profile.uid", "PROFILE UID HERE"); //profile UID
...
settings.setValue('GameConstants.GameMajor', "GAMEMAJOR VERSION HERE"); //GameMajor version here. ex: 0.12.3.6090
settings.setValue('GameConstants.UnityPlayerVersion', "UNITYPLAYER VERSION HERE"); //UnityPlayer Version. ex: UnityPlayer/2018.4.13f1 (UnityWebRequest/1.0, libcurl/7.52.0-DEV)
settings.setValue('GameConstants.LauncherVersion', "LAUNCHER VERSION HERE"); //Launcher Version. ex: 0.9.3.1057
settings.setValue('GameConstants.XUnityVersion', "LAUNCHER VERSION HERE"); //XUnity Version. ex: 2018.4.13f1
settings.setValue('GameConstants.AppVersion', ""); //AppVersion. ex: EFT Client 0.12.3.6090
//=====================================================
// main libraries
...
//=====================================================
// Local Script files
global.scaling  = require('./scaling.js');
global.util 	= require('./utility.js');
global.login_f 	= require('./_login.js');
